...
import type { PredictionJob, PredictionsPayload } from "@/lib/api/contracts";
...
export default function PredictionPage() {
  ...
  return (
    <AppShell title={t("nav.prediction")}>
      <PageHeading title={t("prediction.title")} subtitle={t("prediction.subtitle")} />
